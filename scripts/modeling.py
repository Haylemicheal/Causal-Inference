...
class Model:
    ...
    def preprocess(self):
        ...
        pipeline = Pipeline(steps=[
            ('target_feature_split', FunctionTransformer(self.split_target_feature, kw_args={'target_col':'driver_action'}, validate=False)),
    ...
    def train(self, args, exp_name):
        ...
        with mlflow.start_run():
            ...
            result_df["Actual"] = self.preprocessed_data[3]
            result_agg = result_df.groupby("month").agg(
